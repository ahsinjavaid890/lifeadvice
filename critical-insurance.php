...
<head>
    ...
    <title>Critical Insurance</title>
</head>
...
<div class="health-inssurance-hero-banner pt-5">          
    <div class="container-homepage">
        <div class="row">
            <div class="col-md-6">
                <div class="herrotext">
                    <h2 class="wow fadeInUp" data-wow-delay=".4s"><span>Critical Illness</span> Insurance</h2>
                    <h5 class="wow fadeInUp  text-justify" data-wow-delay=".6s"><span>What Makes Life Advice Extra Smart?</span></h5>
            ...
            <div class="col-md-6">
                <div class="hero-image">
                    <img src="assets/img/images/critical-hero.png">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="decide-image">
                    <img src="assets/img/images/critical-insurance.png">
                </div>
            </div>
...
<div class="our-mission-section">
    <div class="container-homepage">
        <div class="row mission-row">
            <div class="col-md-2">
                    <img class="men-image" src="assets/img/images/type-men.png">
            </div>
            <div class="col-md-10">
    ...
    <div class="what-we-offer">
        <div class="container-homepage">
            ...
            <div class="row mission-row">
                ...
                <div class="col-md-6">
                    <img src="assets/img/images/wheelchair.png">
                </div>
            </div>
        </div>
    </div>
           ...
           <div class="card policies-card">
               <div class="card-body">
                   ...
                   <div class="policies-image">
                       <img src="assets/img/images/board.png">
                   </div>
       ...
       <div class="col-md-3 policy-col">
           <div class="card policies-card">
               <div class="card-body">
                   ...
                   <div class="policies-image">
                       <img src="assets/img/images/dollar-bags.png">
                   </div>
                   <div class="policies-text">
       ...
       <div class="col-md-3 policy-col">
           <div class="card policies-card">
               <div class="card-body">
                   ...
                   <div class="policies-image">
                       <img src="assets/img/images/umbrella-dollar.png">
                   </div>
                   <div class="policies-text">
    ...
    <div class="container-homepage">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-2">
                        <img src="assets/img/images/dollar-bag.png">
                    </div>
                    <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-2">
                        <img src="assets/img/images/parashoot.png">
                    </div>
                    <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-2">
                        <img src="assets/img/images/hand-flag.png">
                    </div>
                    <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-2">
                        <img src="assets/img/images/praying.png">
                    </div>
                    <div class="col-md-10">
