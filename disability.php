        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="hero-image">
                    <img src="assets/img/images/capability.jpg">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="decide-image">
                    <img src="assets/img/images/decide.png">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="travel-medical-heading2" style="margin-top:20px;">
                    <h2 class="wow fadeInUp" data-wow-delay=".4s"><span style="color: #262566;">How do I purchase </span>Coverage?</h2>
                </div>
        ...
        <div class="row">
                ...
                <div class="card transparent-card">
                 <div class="card-body text-center">
                    <div class="transparent-card-heading mt-3">
                       <h2 ><span style="color: #262566;"> Short Term  </span>disability insurance</h2>
                    </div>
            ...
            <div class="col-md-5">
                <div class="card transparent-card">
                 <div class="card-body text-center">
                    <div class="transparent-card-heading mt-3">
                       <h2><span style="color: #262566;"> Long Term </span>Disability insurance</h2>
                    </div>
                    <div class="transparent-card-paragraph">
        ...
        <div class="row general-row">
            <div class="col-md-12 d-flex">
                ...
                <div class="term-image">
                    <img style="width:160px;" src="assets/img/images/clipboard.png">
                </div>
            </div>
        </div>
    </div>
...
<section class="defination pb-5 pt-6">
    <div class="container-homepage">
        <div class="row">
            <div class="col-md-6">
                <img src="assets/img/images/defination.jpg">
            </div>
            <div class="col-md-6">
                <h2><span style="color: #262566;"> Definition </span>of disability</h2>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="card transparent-card">
                 <div class="card-body text-center">
                    <div class="transparent-card-heading mt-3">
                       <h2 ><span style="color: #262566;"> Any  </span>occupation</h2>
                    </div>
                    <div class="transparent-card-paragraph">
            ...
            <div class="col-md-4">
                <div class="card transparent-card">
                 <div class="card-body text-center">
                    <div class="transparent-card-heading mt-3">
                       <h2><span style="color: #262566;"> Regular</span>Occupation</h2>
                    </div>
                    <div class="transparent-card-paragraph">
            ...
            <div class="col-md-4">
                <div class="card transparent-card">
                 <div class="card-body text-center">
                    <div class="transparent-card-heading mt-3">
                       <h2><span style="color: #262566;"> Own  </span> occupation</h2>
                    </div>
                    <div class="transparent-card-paragraph">
        ...
        <div class="row  general-row">
            <div class="col-md-6">
                <div class="wainting-heading">
                    <h2><span style="color: #262566;"> Waiting  </span> period</h2>
                </div>
            ...
            <div class="col-md-6">
                <img src="assets/img/images/calender.png">
            </div>
        </div>
    </div>
</section>
