...
$del_q = mysqli_query($db, "DELETE FROM `wp_dh_insurance_plans` WHERE `id`='".$_REQUEST['id']."'");
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							...
							<span class="title elipsis">
								<strong><i class="fa fa-umbrella"></i> MANAGE PLANS</strong> <!-- panel title -->
							</span>
							</div>
							<div class="col-md-6">
<button type="button" onClick="window.location='add_plan.php?action=addnew'" class="btn btn-primary pull-right" style="margin-top: -9px;"><i class="fa fa-plus"></i> Add New Plan</button>
							</div>	
						</div>
						<!-- panel content -->
...
$srno = 0;
$sql = mysqli_query($db, "SELECT * FROM `wp_dh_insurance_plans`");
...
?>
									...
									<tr class="odd gradeX">
										...
										<td>Administrator</td>
                                        <td>
										<a href="add_plan.php?id=<?php echo $plan_id;?>" class="btn btn-default btn-xs"><i class="fa fa-edit white"></i> Edit </a>
