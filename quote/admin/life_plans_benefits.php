...
$del_q = mysqli_query($db, "DELETE FROM `wp_dh_life_plans_benefits` WHERE `plan_id`='".$_REQUEST['id']."'");
		...
		<div id="wrapper">
			...
			<!-- page title -->
				<header id="page-header">
					<h1>Manage Life Benefits</h1>
					<ol class="breadcrumb">
						<li><a href="plans_benefits.php">Life Plans Benefits</a></li>
						<li class="active">Manage Life Benefits</li>
					</ol>
				</header>
				<!-- /page title -->
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							...
							<span class="title elipsis">
								<strong><i class="fa fa-umbrella"></i> MANAGE LIFE BENEFITS</strong> <!-- panel title -->
							</span>
							</div>
							<div class="col-md-6">
<button type="button" onClick="window.location='add_life_benefit.php?action=addnew'" class="btn btn-primary pull-right" style="margin-top: -9px;"><i class="fa fa-plus"></i> Add Benefits</button>
							</div>	
						</div>
						<!-- panel content -->
...
$srno = 0;
$sql_ben = mysqli_query($db, "SELECT * FROM `wp_dh_life_plans_benefits` GROUP BY `plan_id` ORDER BY `plan_id`");
while($sql_ben_f = mysqli_fetch_assoc($sql_ben)){
$srno++;
$sql = mysqli_query($db, "SELECT * FROM `wp_dh_life_plans` WHERE `id`='".$sql_ben_f['plan_id']."'");
...
?>
									...
									<tr class="odd gradeX">
                                        ...
                                        <td>
										<a href="add_life_benefit.php?id=<?php echo $plan_id;?>" class="btn btn-default btn-xs"><i class="fa fa-edit white"></i> Edit </a>
