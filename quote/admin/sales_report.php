			...
			<div id="content" class="padding-20">
					...
					<div class="panel-heading">
							...
							<span class="title elipsis">
								<strong>Sales Report</strong> <!-- panel title -->
							</span>
							</div>
						</div>
						<!-- panel content -->
						...
						<div class="row">
                            ...
                            <form method="post" action="?action=done" id="form">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><input type="text" name="start_date" class="form-control datepicker" style="height: 39px;" id="start_date" value="<?php echo $_POST['start_date'];?>" required></td>
                                            <td><input type="text" name="end_date" class="form-control datepicker" style="height: 39px;" id="end_date" value="<?php echo $_POST['end_date'];?>" required></td>
                                            ...
                                            <td><input type="button" class="btn btn-success" value="Generate Report" onClick="generatereport()"> <?php if($_REQUEST['action'] == 'done'){?><!--<button type="button" style="padding: 2px;" class="btn btn-primary" onClick="downloadpdf()"><i class="fa fa-file"></i> Download</button>--> <?php } ?></td>
                                        </tr>                           
                                      </tbody>
                                    </table>
                            </form>        
