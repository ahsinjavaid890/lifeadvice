					...
					<label><i class="fa fa-building"></i> <strong>Select Plan</strong></label>
						<select autocomplete="on" name="plan_id" id="plan_id" class="form-control select2">
							<option value="">None</option>
									<?php
									$pl_q = mysqli_query($db, "SELECT * FROM `wp_dh_insurance_plans` ORDER BY `id`");
...
<div class="appendBenefits">
					<div class="row">
						<div class="col-md-12">
							<input id="ibenefitHead1" name="ibenefitHead[]" class="form-control" value="<?php echo $be_f['benefits_head'];?>" placeholder="Enter Heading of Benefit" type="text">
						</div>
					</div>

					<div class="row">
						<div class="col-md-12">
							<textarea placeholder="Enter benefit Description" class="form-control" spellcheck="false" id="ibenefitDesc1" name="ibenefitDesc[]"><?php echo $be_f['benefits_desc'];?></textarea>
						</div>
					</div>
</div>					
<?php } ?>
