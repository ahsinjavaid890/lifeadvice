...
<div class="row filterdiv hidden-xs" style="border: 1px solid #ddd;text-align: center;padding-top: 10px;border-top: 4px solid #DDD; margin-bottom:20px;">	
...
<div class="row plan-details   deductable-<?php echo $deductible; ?>" style="display: <?php if($deductible == '1000'){ echo 'block'; } else if($havethousand == 'no' && $deductible == '0'){ echo 'bock'; } else { echo 'none'; } ?>; margin-top:0; margin-left:0; margin-right:0; margin-bottom 5px !important;border-bottom: 1px solid #0084c1;">
	...
	<img src="images/<?php echo $comp_logo ?>"/>
	</div>
	...
	<div class="col-md-4 col-xs-12 text-center" style="border:2px solid #f5821f; padding:10px;box-shadow: 0px 0px 5px 0px #999 inset;">
		...
		<h1 style="padding: 0;margin: 0;line-height: normal;">$<?php echo str_replace(',','', number_format($total_price,2));?></h1>
...
?>
	<div class="compare col-md-3 col-xs-12 text-center buttons_block"><a class="submit-btn col-md-12 col-xs-5 " onclick="$('.buynow_<?php echo $deductible.$plan_id;?>').fadeIn();" style="font-weight: bold;padding: 6px 20px;font-size: 16px;display: block;color: #FFF; margin-bottom:5px;margin-top: 10px;border-radius: 6px;border-bottom: 2px solid #999;box-shadow: none;"><i class="fa fa-shopping-cart"></i> Buy Now</a>
