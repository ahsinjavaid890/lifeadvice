...
<?php
    ...
    $limiter = 0; // THIS WILL LIMIT THE QUOTATION TO TWO
                                ...
                                <div class="row plan-details   deductable-<?php echo $deductible; ?>"
                                    ...
                                    <div class="col-md-4 col-xs-6 text-center" id="price">
                                        <h3 style="display:inline;margin:0;font-size:30px;">
                                            $<span style="color: #000;font-weight: bold;"><?php echo str_replace(',', '',$explode[0]).'.';?><sup class="superior" style="font-size: 17px;"><?php echo $explode[1];?></sup></span>
                                        </h3>
<?php
                    if($monthly_two == '1'){
