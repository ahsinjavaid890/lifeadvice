	...
	document.getElementById('change_display').value = '0';	
        ...
        <div class="col-md-3 side-bar filterdiv hidden-xs">
            ...
            <div class="col-md-12 text-center quote_reference">
				...
				<h3 style="margin: 0; font-size:16px; color:#44bc9b;"><?php echo $randomquote; ?></h3>
            </div>
...
<p></p>
<p><a class="submit-btn" href="<?php echo $buynow_url;?>" style="display: block;"><i class="fa fa-shopping-cart"></i> Buy Now</a></p>
</div>
