		...
		<div class="col-md-12 col-sm-12 col-xs-12 pull-left" style="padding-right: 0px; padding-left: 0px; ">
			...
			if(isset($allow_input_field['traveller']) && $allow_input_field['traveller'] == "on" ){
                ...
                <?php   if(isset($allow_input_field['dob']) && $allow_input_field['dob'] == "on" ){    ?>
					<div class="col-md-6 col-sm-6 col-xs-12 control-input">
						<div class="birthday">
                               <label class="input-label">Age of Traveller</label>
<select name="years[]" id="years[]" class="form-control" required="required" onchange="numoftravelers()">
<?php $maxyear = date('Y'); 
$i = $maxyear;
$year = date('Y');
while($i>1918) {?>
       ...
       <!-- Smoke in 12 month o not -->
		...
		if(isset($allow_input_field['Smoke12']) && $allow_input_field['Smoke12'] == "on" ){ ?>
			<div class="col-md-12 col-sm-12 col-xs-12" style="padding-right: 0px; padding-left: 0px; float:left;">
				<div class="col-md-12 col-sm-12 control-label "  style="text-align: left; width:100%;" >
					<label class="input-label">Do you Smoke in last 12 months ? </label> </div>
				<div class="col-md-12 col-sm-12 control-input">
					<div class="toggle-button toggle-button-icon-fade">
						<input id="Smoke12-4"  type="checkbox" name="Smoke12">
						<label for="Smoke12-4" data-on-text="Yes" data-off-text="No"></label>
        ...
        <!---Traveller Smoke-->
			...
			<?php
				...
				<div class="toggle-button toggle-button-icon-fade">
							<input id="checkbox-4"  type="checkbox" name="traveller_Smoke">
							<label for="checkbox-4" data-on-text="Yes, I Do" data-off-text="No, I Don't"></label>
							<div class="toggle-button__icon"></div>
						</div>
				</div>
...
background: #F1F1F1;
				...
				<div class="col-md-12 col-sm-12" style="padding-right: 0px; padding-left: 0px;">
				<div class="col-md-12 col-sm-12" style="padding-right: 0px; padding-left: 0px;">
					<div class="col-md-12 col-sm-12 control-label "  style="text-align: left;">  </div>
           ...
           <!-- Start Date  and End date -->
            ...
            <input  id="departure_date"  name="departure_date" value="" class="form-control"  type="text" placeholder="Start Date" required <?php if($supervisa == 'yes'){?> onchange="supervisayes()" <?php } ?>>
				...
				<div class="col-md-6 col-sm-6 col-xs-12 control-input" style="padding-right:0px;">
                        ...
                        <input id="return_date" name="return_date" class="form-control"  type="text" required <?php if($supervisa == 'yes'){?> readonly="true" <?php } ?> value="">
...
<?php if(isset($allow_input_field['traveller_gender']) && $allow_input_field['traveller_gender'] == "on" ){ ?>
    <div class="col-md-12 control-input gender-main">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 control-input no-padding input custom_traveller" style="padding:0;">
			<div class="toggle-button toggle-button-icon-fade gender">
					<input id="checkbox-6"  type="checkbox" name="old_traveller_gender">
					<label for="checkbox-6" data-on-text="Male" data-off-text="Female"></label>
					<div class="toggle-button__icon"></div>
				</div>
       ...
       <!--   Gender of person -->
		...
		if(isset($allow_input_field['gender']) && $allow_input_field['gender'] == "on" ){ ?>
		   <div class="col-md-12" style="padding:0px;">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 control-input">
                 <div class="toggle-button toggle-button-icon-fade gender">
					<input id="checkbox-6"  type="checkbox" name="gender">
					<label for="checkbox-6" data-on-text="Male" data-off-text="Female"></label>
					<div class="toggle-button__icon"></div>
				</div>
			</div>
			...
			if(isset($allow_input_field['fplan']) && $allow_input_field['fplan'] == "on" ){ ?>
				<div class="col-md-6 col-sm-6 col-xs-12" style="padding-right: 0px; padding-left: 0px;">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 control-input"  >
						...
						<div class="toggle-button toggle-button-icon-fade">
							<input id="checkbox-4"  type="checkbox" name="familyplan">
							<label for="checkbox-4" data-on-text="Yes, I Want" data-off-text="No, I Don't Want" onclick="changefamily()"></label>
							<div class="toggle-button__icon"></div>
						</div>
			...
			if(isset($allow_input_field['pre_existing']) && $allow_input_field['pre_existing'] == "on" ){ ?>
				<div class="col-md-6 col-sm-6" style="padding-right: 0px; padding-left: 0px;">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 control-input" style=" float:right;">
						...
						<div class="toggle-button toggle-button-icon-fade">
							<input id="checkbox-5"  type="checkbox"  name="pre_existing" >
							<label for="checkbox-5" data-on-text="Yes, I Have" data-off-text="No, I Haven't"  name="pre_existing"></label>
							<div class="toggle-button__icon"></div>
						</div>
         ...
         <?php } /*** end of for loop ***/ ?>
		   ...
		   <span id="family_error" style="display: none; font-size: 16px;font-weight: bold;text-align: right;padding: 20px;" class="text-danger"><i class="fa fa-warning"></i> </span>
			<div class="center m-t-30px">
				<button type="submit" name="GET QUOTES" id="GET_QUOTES"  class="btn btn-danger bg-red show-loading-popup" style="border: 1px solid #01a281;padding: 10px 30px;"><i class="fa fa-list"></i> Get a Quote </button>
			</div>
		</div>
