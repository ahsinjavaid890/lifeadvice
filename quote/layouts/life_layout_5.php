...
<h1 class="text-center" style="color:#FFF;">Information about yourself</h1>
<p class="sub-heading" style="color:#FFF;">This information is required in order to provide accurate rates.</p>
</div>
</div>

<div class="row">
<div class="col-md-6 col-lg-offset-3 fields" style="box-shadow: 0 0 16px rgba(0,0,0,0.27);border-radius: 10px;text-align: center;padding: 3em 5em;">
<div class="col-md-12" style="margin-bottom: 10px;">
<label><i class="fa fa-map-marker"></i> Postal Code <small class="text-danger" id="postal_error"></small></label>
...
<select name="month" id="month" class="form-control" style="height: 61px !important; font-size: 25px !important;">
...
<select name="years" id="add_1" class="form-control" style="height: 61px !important; font-size: 25px !important;">
...
<div class="col-md-12 form-control" style="margin-bottom: 10px; padding:0;">
<!-- radio -->
<label class="radio">
