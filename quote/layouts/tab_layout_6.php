...
<div class="col-md-12">
			<?php if($supervisa == 'yes'){?>
<input autocomplete="off" id="departure_date"  name="departure_date" placeholder="Start Date" value="" class="form-control" type="text" required <?php if($supervisa == 'yes'){?> onchange="supervisayes()" <?php } ?>>
