...
if(displayvalue == '0'){
	...
	<div class="col-md-3 side-bar filterdiv hidden-xs">
        ...
        <div class="col-md-12 adjust-quoto" style="padding-top:20px;">
            <h2 style="margin: 0;">Adjust your quotes</h2>
            <h4 class="deductible" style="margin: 0;padding: 0;font-weight: bold;margin-bottom: 0;border: none;text-align: left;">Duration: <input type="text" id="coverage_deductible" name="coverage_deductible" value="1 year(s)" style="border:0;  color:#444; font-weight:bold;background: no-repeat;margin: 0;padding-left: 10px;text-align: left;width: 140px;"></h4>
        ...
        <div class="col-md-12 adjust-quoto" style="border-top:0px">
            <h4 class="coverage" style="margin: 0;padding: 0;font-weight: bold;margin-bottom: 0;border: none;text-align: left;">Coverage: <input type="text" id="coverage_amount" name="coverage_amount" value="$<?php echo $_SESSION['sum_insured2'];?>" style="border:0;  color:#444; font-weight:bold;background: no-repeat;margin: 0;padding-left: 10px;text-align: left;width: 140px;"></h4>
...
if($total_price > 0){
?>
				 <div class="desktop-compare listing-item ratebase-<?php echo $rate_base;?>" data-listing-price="<?php echo str_replace(',', '', number_format($total_price));?>">
                <div class="coverage-amt coverage-amt-<?php echo $sum_insured; ?>"   style="display: <?php if($_SESSION['sum_insured2'] == $sum_insured ){ echo 'block'; } else { echo 'none'; } ?>; vertical-align: inherit; ">
                    <div class="row plan-details  deductable-<?php echo $duration; ?>"  style="border:1px solid #c0c0c0;margin-bottom: 20px !important; display: <?php if($duration == '1'){ echo 'block'; } else { echo 'none'; } ?>;">
                        <div class="col-md-4" style="border:0px solid #000;  text-align:centerk;padding: 5px 0; ">
                            <i class="fa fa-exclamation-circle dh-toggle" data-value='<?php echo $sum_insured.$duration.$plan_id; ?>' style="cursor:pointer;position: absolute;top: 43%;left: 0;" aria-hidden="true"></i> &nbsp;
                            <img  style="min-height:20px; margin-left: 20px" width="170" height="60"  src="admin/uploads/<?php echo $comp_logo; ?>"/>
                        </div>

             <div class="col-md-2" style="border:0px solid #000;font-size: 20px;padding: 15px 0; text-align:center;"><?php  echo $duration; ?><br/> Year(s)</div>

                        <div class="col-md-3" style="border:0px solid #000; text-align: center; padding: 10px 0;">
                            <h2 style="font-weight:normall;display:inline;font-size: 30px;line-height: 30px">$<?php echo number_format($total_price,2); // $planID2->sum_insured + ?>
							</h2>	
							<p><?php if($rate_base == '1'){ echo 'Monthly'; } else { echo 'Yearly'; } ?></p>
...
?>
                            ...
                            <button onclick="$('.buynow_<?php echo $duration.$plan_id;?>').fadeIn();" class="submit-btn" data-value="<?php echo $plan_id; ?>" style="background: #1c9b22;font-size: 16px;width: 100%;padding: 10px 0 !important;border: 0;box-shadow: 0px 1px 1px 0px #ccc;border:0; color:#FFF;border: 1px solid #025302;" class="btn btn-lg btn-danger" name="buynow">Buy this plan</button>
                            <div class="compare">
        ...
        margin-left: -25px;" type="checkbox" tabindex="0" class="hidden1" value="<?php echo str_replace(',', '', number_format($total_price));?>" onclick="comparetest()">Add to Compare</label>
                        ...
                        <div class="col-md-12 dh-toggle-show-hide-<?php echo $sum_insured.$duration.$plan_id; ?>"  style="display:none;">
                            <div class="col-md-6">
