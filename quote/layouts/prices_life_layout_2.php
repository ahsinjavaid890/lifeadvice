...
<div class="row filterdiv hidden-xs" style="border: 1px solid #ddd;background: #F9F9F9;text-align: center;padding-top: 10px;border-top: 4px solid #DDD;">	
	...
	<div class="col-md-3 adjust-quoto" style="border:none;">
                <h4 class="deductible" style="margin: 0;padding: 0;font-weight: bold;margin-bottom: 0;border: none;text-align: left;">Duration: <input type="text" id="coverage_deductible" name="coverage_deductible" value="1 year(s)" style="border:0; font-size:24px; color:#444; font-weight:bold;background: no-repeat;margin: 0;padding: 0;text-align: center;width: 100px;"></h4>
...
<div class="coverage-amt coverage-amt-<?php echo $sum_insured; ?>" style=" display: <?php if($sum_insured == '100000'){ echo 'block'; } else { echo 'none'; } ?>;">
<div class="row plan-details   deductable-<?php echo $duration; ?>" style="display: <?php if($duration == '1'){ echo 'block'; } else { echo 'none'; } ?>; padding: 0;">
<div class="col-md-2 text-center" style="padding-top: 20px;">
<img style="width:100%;" src="admin/uploads/<?php echo $comp_logo; ?>"/>
</div>
...
<h2><?php echo $duration; ?> Year(s)</h2>
</div>
...
<h2 style="color: #C00;font-weight: bold;font-size: 26px;font-family: arial;">$<?php echo number_format($total_price,2);?>
<small style="font-weight: bold;font-size: 13px;"><?php if($rate_base == '1'){ echo '/Month'; } else { echo '/Year'; } ?></small></h2>
</div>
</div>
<div class="row" style="background:#F9F9F9;padding-bottom: 10px;">
<div class="col-md-2 col-xs-6">
<button type="button" class="btn btn-default dh-toggle" data-value='<?php echo $sum_insured.$duration.$plan_id; ?>' aria-hidden="true" style="width: 100%;display: block;border: 1px solid #BBB;padding: 9px 0;margin-top: 2px;border-radius: 0;background: #F1F1F1 !important;color: #333 !important;"><i class="fa fa-plus"></i> More Details</button>
</div>
<div class="compare col-md-3 hidden-xs" style="padding-top: 7px;">
<label><input data-productid="<?php echo $product_id; ?>" data-pid="<?php echo $plan_id; ?>" price="<?php echo str_replace(',', '', number_format($total_price));?>" type="checkbox" tabindex="0" class="hidden1" value="<?php echo str_replace(',', '', number_format($total_price));?>" style="height: auto;margin: 0;" onclick="comparetest()">
...
?>
<a class="submit-btn" onclick="$('.buynow_<?php echo $duration.$plan_id;?>').fadeIn();" style="font-weight: bold;padding: 7px 20px;box-shadow: none;border: 1px solid #999;font-size: 16px;display: block;color: #FFF;background: #44bc9b;border-radius: 0;margin-top: 2px;"><i class="fa fa-shopping-cart"></i> Buy Now</a>
</div>

</div>

<div class="row">
<div class="col-md-12 dh-toggle-show-hide-<?php echo $sum_insured.$duration.$plan_id; ?>" style="display:none; font-size:16px;">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <ul style="margin: 0;padding: 0;">
                                            <li style="list-style: none;font-size: 13px;"><?php echo $duration; ?> Year(s) Duration</li>
                                        </ul>
