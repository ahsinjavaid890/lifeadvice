...
<img style="width:auto; max-height: 110px;" src="images/<?php echo $comp_logo; ?>"/>
...
<label style="border: 1px solid #CCC;padding: 10px;text-align: center;display: block;background: #F9F9F9;box-shadow: 0px 0px 1px 0px #CCC inset;border-radius: 3px;cursor: pointer;font-weight: bold;margin-bottom: 10px;"><input data-productid="<?php echo $product_id; ?>" data-pid="<?php echo $plan_id; ?>" price="<?php echo str_replace(',', '', number_format($total_price));?>" type="checkbox" tabindex="0" class="hidden1" value="<?php echo str_replace(',', '', number_format($total_price));?>" style="height: auto;margin: 0;" onclick="comparetest()">
	...
	<p><input type="checkbox" name="agree" style="height: auto;margin: 0;"> I give permission to LifeAdvice.ca to transfer my quote information and contact details to <?php echo $comp_name;?> in order to complete the purchase of travel insurance. LifeAdvice values your privacy. For details, see our <a href="/">Privacy Policy</a></p>
		<p></p>
	<p><a class="submit-btn" href="<?php echo $buynow_url;?>" style="font-weight: bold;padding: 7px 20px;box-shadow: none;border: 1px solid #999;font-size: 16px;display: block;color: #FFF;background: #C00;border-radius: 5px;margin-top: 2px; margin-bottom:10px;"><i class="fa fa-shopping-cart"></i> Buy Now</a></p>
	</div>
