...
<h1 class="text-center">Choose your coverage.</h1>
<p class="sub-heading">Tell us more about your coverage to understand your needs.</p>
</div>
</div>
...
<div class="col-md-12 graybox" style="margin-bottom: 10px;">
<label><i class="fa fa-fire"></i> Do you Smoke in last 12 months ?</label>
<!-- success -->
...
<div class="col-md-12 graybox" style="margin-bottom: 10px;">
<label><i class="fa fa-wheelchair"></i> Do you have any Pre-existing Condition ?</label>
<!-- success -->
<label class="switch switch-success switch-round pull-right">
...
if($allow_input_field['pre_existing'] == "on" ){ ?>
<div class="col-md-12 graybox" style="margin-bottom: 10px;">
<label><i class="fa fa-child"></i>  Do you require Family Plan ?</label>
<!-- success -->
<label class="switch switch-success switch-round pull-right">
	<input type="checkbox" name="fplan" <?php if($_SESSION['fplan'] == 'yes'){?> checked="" <?php } ?> value="yes" onclick="changefamily()">
	<span class="switch-label" data-on="YES" data-off="NO"></span>
</label>
...
//Eligibility
var inps = '<?php echo json_encode($_SESSION['years']);?>';
var ages = [];
