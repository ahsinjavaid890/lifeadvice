        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="hero-image">
                    <img src="assets/img/images/umbrellla-card.jpg">
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="benefit-card-image d-flex align-items-center">
                                            <img src="assets/img/images/safe-laptop.png" class="mr-3">
                        ...
                        <div class="card benefit-card mt-3">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="benefit-card-image d-flex align-items-center">
                                            <img src="assets/img/images/safe-home.png" class="mr-3">
                        ...
                        <div class="card benefits-card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="benefit-card-image d-flex align-items-center">
                                            <img src="assets/img/images/heart-health.png" class="mr-3">
                        ...
                        <div class="card benefits-card mt-3">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="benefit-card-image d-flex align-items-center">
                                            <img src="assets/img/images/safe-dollar.png" class="mr-3">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card drug-card">
                    <div class="card-body">
                            <div class="health-image d-flex align-items-center">
                                <img src="assets/img/images/tablet.png" class="mr-3">
                                <h2>Drug</h2>
                            </div>
                    </div>
                </div>
                <div class="card mt-4 drug-card">
                    <div class="card-body">
                            <div class="health-image d-flex align-items-center">
                                <img src="assets/img/images/signal-people.png" class="mr-3">
                ...
                <div class="card mt-4 drug-card">
                    <div class="card-body">
                            <div class="health-image d-flex align-items-center">
                                <img src="assets/img/images/hand-health.png" class="mr-3">
            ...
            <div class="col-md-4">
                ...
                <img src="assets/img/images/insurance-board.gif">
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="summary-visitor-list">
            ...
            <div class="col-md-5">
                <div class="benefit-image">
                    <img src="assets/img/images/health-final.png">
                </div>
            </div>
        </div>
        </div>
