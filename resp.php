...
<div class="health-inssurance-hero-banner pt-5">          
    <div class="container-homepage">
        <div class="row">
            <div class="col-md-6">
                <div class="herrotext">
                    <h2 class="wow fadeInUp" data-wow-delay=".4s"><span>Education </span>Plan</h2>
            ...
            <div class="col-md-6">
                <div class="hero-image">
                    <img src="assets/img/images/resp.gif">
                </div>
            </div>
        </div>
    </div>
   ...
   <section class="claim-process pb-5 pt-5">
       <div class="container-homepage">
           <div class="row">
               <div class="col-md-6">
                   <img src="assets/img/images/png123.gif">
               </div>
               <div class="col-md-6">
   ...
   <section class="claim-process bg-white pb-5 pt-5">
       <div class="container-homepage">
           <div class="row">
               ...
               <div class="col-md-6">
                   <img src="assets/img/images/png1.gif">
               </div>
           </div>
       </div>
   </section>
   <section class="claim-process pb-5 pt-5">
       <div class="container-homepage">
           <div class="row">
               <div class="col-md-6">
                   <img src="assets/img/images/png01.gif">
               </div>
               <div class="col-md-6">
                   <div class="claim-process-heading mt-5">
   ...
   <section class="claim-process bg-white pb-5 pt-5">
       <div class="container-homepage">
           <div class="row">
               ...
               <div class="col-md-6">
                   <img src="assets/img/images/png12.gif">
               </div>
           </div>
       </div>
   </section>
   <section class="claim-process pb-5 pt-5">
       <div class="container-homepage">
           <div class="row">
               <div class="col-md-6">
                   <img src="assets/img/images/pn1g123.gif">
               </div>
               <div class="col-md-6">
                   <div class="claim-process-heading mt-5">
