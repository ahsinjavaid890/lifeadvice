        ...
        <div class="row">
            <div class="col-md-6 image-center">
                <div class="student-medical-image">
                    <img src="assets/img/images/travel1.png">
                </div>
            </div>
            <div class="col-md-6">
...
<section class="fourth-section">
    <div class="container-homepage">
        ...
        <div class="benifitrow row">
            <div class="col-md-6">
                <img src="assets/img/images/travel3.png">
            </div>
            <div class="col-md-6">
...
<style type="text/css">
    .covid{
        background-image: url(assets/img/images/visa-background.png);
