...
<div class="health-inssurance-hero-banner pt-5">          
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="hero-image">
                    <img src="assets/img/images/claim-hero.gif">
                </div>
            </div>
        </div>
    </div>
   ...
   <section class="claim-process pb-5 pt-5">
       <div class="container-homepage">
           <div class="row">
               <div class="col-md-5">
                   <img src="assets/img/images/22.gif">
               </div>
               <div class="col-md-7">
    ...
    <div class="">
        <div class="row aboutussecondrows">
                    ...
                    <div class="card-body">
                        <div class="claim-card text-center">
                            <h6 class="text-white">Check Claims Status</h6>
                                <img src="assets/img/images/approved.gif">
            ...
            <div class="col-md-4">
                <img src="assets/img/images/left-arrow.png" class="left-arrow mt-5">
                <h2 class="text-white">Need assistance with an existing claim?</h2>
                <img src="assets/img/images/right-arrow.png" class="right-arrow float-right">
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
    ...
    <div class="container-homepage">
        <div class="row">
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/tl.jpg">
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/GMS.png">
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/21_century.png">
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/tugo.png">
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/manulife.png">
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/Blue-cross.png">
                        <h2><span>Plan</span>-a</h2>
                        <hr class="hr-tag">
                        <a href="#" class="btn btn-block claim-btn">Claim Form</a>
                        <a href="#" class="btn btn-block policy-btn">Claim Form</a>
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/rsz.png">
                        <h2><span>Plan</span>-b</h2>
                        <hr class="hr-tag">
                        <a href="#" class="btn btn-block claim-btn">Claim Form</a>
                        <a href="#" class="btn btn-block policy-btn">Claim Form</a>
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/destination.png">
                        <h2><span>Premier </span>Plan</h2>
                        <hr class="hr-tag">
                        <a href="#" class="btn btn-block claim-btn">Claim Form</a>
                        <a href="#" class="btn btn-block policy-btn">Claim Form</a>
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/INGLE.png">
                        <h2><span>Plan</span>-a</h2>
                        <hr class="hr-tag">
                        <a href="#" class="btn btn-block claim-btn">Claim Form</a>
                        <a href="#" class="btn btn-block policy-btn">Claim Form</a>
            ...
            <div class="col-md-3 mt-4">
                 <div class="card transparent-cards">
                    <div class="card-body text-center">
                        <img src="assets/img/logos/allianz.png">
                        <h2><span>Plan</span>- A</h2>
                        <hr class="hr-tag">
                        <a href="#" class="btn btn-block claim-btn">Claim Form</a>
                        <a href="#" class="btn btn-block policy-btn">Claim Form</a>
