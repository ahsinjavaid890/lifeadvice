...
<div class="health-inssurance-hero-banner pt-5">          
    <div class="container-homepage">
        <div class="row">
            <div class="col-md-6">
                <div class="herrotext"> 
                    <h2 class="wow fadeInUp" data-wow-delay=".4s"><span>Life </span>Insurance</h2>
                    <h5 class="wow fadeInUp  text-justify" data-wow-delay=".6s"><span>Life insurance products provides your spouse and family with peace of mind, by giving them the financial options to help make important and often difficult decisions during a very stressful time.</span></h5>
            ...
            <div class="col-md-6">
                <div class="hero-image">
                    <img src="assets/img/images/life-hero.png">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 image-center">
                <div class="student-medical-image">
                    <img src="assets/img/sectontwo.png">
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="card" style="border: 1px solid black;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <img src="assets/img/images/umbrela2.png" style="width:150px;">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3">
                    <div class="card transparent-card">
                         <div class="card-body text-center">
                            <div class="simple-online-transparent-slider">
                               <img src="assets/img/images/umbrela1.png">
                            </div>
                 ...
                 <div class="col-md-3">
                    <div class="card transparent-card">
                         <div class="card-body text-center">
                            <div class="simple-online-transparent-slider">
                               <img src="assets/img/images/dolor.png">
                            </div>
                            <div class="transparent-card-heading mt-3">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="card transparent-card">
                         <div class="card-body text-center">
                            <div class="simple-online-transparent-slider">
                               <img src="assets/img/images/flag.png">
                            </div>
                            <div class="transparent-card-heading mt-3">
                 ...
                 <div class="col-md-3">
                    <div class="card transparent-card">
                         <div class="card-body text-center">
                            <div class="simple-online-transparent-slider">
                               <img src="assets/img/images/security.png">
                            </div>
                            <div class="transparent-card-heading mt-3">
                               <h2>Dual Security</h2>
                            </div>
            ...
            <div class="row counter-row" style=" align-items: center;">
                ...
                <div class="col-md-4">
                    <div class="counter-image" style="width: 480px;">
                        <img src="assets/img/images/counter-image.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="team-area team-area-five at-galace" style="background: whitesmoke;">
        <div class="container-homepage">
            ...
            <div class="glance-image text-center">
                <img src="assets/img/images/left-line.png">
                <img src="assets/img/images/line.png"> 
                <img src="assets/img/images/right-line.png">
            </div>
                    ...
                    <div class="card glance-card">
                        <div class="card-body glance-body">
                            <div class="glance-images">
                                <img src="assets/img/images/dollars.png">
                            </div>
            ...
            <div class="row" style="align-items: center;">
                <div class="col-md-5 universal-image-main">
                    <div class="universal-image">
                        <img src="assets/img/images/universal.png">
                    </div>
                </div>
                    <div class="col-md-7">
